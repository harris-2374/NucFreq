...
def main():
    ...
    parser.add_argument(
        "--obed", default=None, help="output a bed with the data points"
    )
    parser.add_argument(
        "--minobed",
    ...
    parser.add_argument(
        "-y", "--ylim", help="max y axis limit", type=float, default=None
    )
    parser.add_argument(
        "-f", "--font-size", help="plot font-size", type=int, default=16
    )
